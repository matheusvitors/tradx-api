...
describe.skip('Remove Operacao Controller', () => {
	...
	it('should remove Operacao', async () => {
		const response = await removeController<Operacao, OperacaoDTO>({ id: "abc", repository: operacaoRepository });
	...
	it('should return 404 if Operacao not found', async () => {
		const response = await removeController<Operacao, OperacaoDTO>({id: 'eee', repository: operacaoRepository});
